...
本项目旨在基于**Faster R-CNN**框架，在DOTA遥感图像数据集中实现对飞机的**倾斜目标框 (Oriented Bounding Box - OBB)** 检测，借鉴YOLT在大图处理、小目标/多尺度检测和实验分析方面的经验，并在此基础上引入高斯光斑遮挡模拟，系统研究遮挡条件下遥感飞机检测的性能与挑战。
