...
if __name__ == '__main__':
    ...
    # 1. 输入路径
    input_image_dir = r"E:\RS_Aircraft_Occlusion_Detection\dataset\original_val\images"
    input_label_dir = r"E:\RS_Aircraft_Occlusion_Detection\dataset\original_val\labels"

    # 2. 输出路径
    output_dir = r"E:\RS_Aircraft_Occlusion_Detection\dataset\val\images"
