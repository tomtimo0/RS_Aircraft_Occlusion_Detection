...
if __name__ == '__main__':
    ...
    INPUT_DOTA_LABEL_DIR = "E:/RS_Aircraft_Occlusion_Detection/dataset/train/labelTxt-v2.0"

    # 2. 设置转换后的 YOLO OBB 格式标签文件输出的目录
    OUTPUT_YOLO_LABEL_DIR = "E:/RS_Aircraft_Occlusion_Detection/dataset/train/labels_change"

    # 3. 设置图像文件所在的目录（需要读取图像以获取其尺寸）
    IMAGE_DIR = "E:/RS_Aircraft_Occlusion_Detection/dataset/train/images"
